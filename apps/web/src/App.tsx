    ...
    <main className="app-shell">
      <aside className="sidebar" aria-label="Primary">
        <div className="sidebar-inner">
          ...
          <nav className="nav-list" aria-label="Primary navigation">
            <a href="#workstreams" aria-current="page">Workstreams</a>
          ...
          <div className="sidebar-panels">
            <div className="runtime-panel">
              ...
              <strong>
                {runtimeInfo?.electronVersion ? `Electron ${runtimeInfo.electronVersion}` : "Electron"}
              </strong>
      ...
      <section className="workspace" id="workstreams">
        ...
        <section className="summary-band" aria-label="Current workstream summary">
          <div>
            <span
              className={`status-dot${isRunning ? "" : " idle"}`}
              aria-hidden="true"
            />
            <p>
              {workstreams.length > 0
                ? `${workstreams.length} persisted workstream(s)`
                : "Ready for the first workstream"}
            </p>
          </div>
          <strong>
            ...
            ? workstreams.slice(0, 3).map((workstream) => (
                <article className="section-card" key={workstream.id}>
                  ...
                  <button
                    ...
                    onClick={() => appendTimelineEvent(workstream.id)}
                  >
                    Add event
                  </button>
                </article>
